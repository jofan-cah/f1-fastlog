            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative">
                    ...
                    <div id="user-dropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-50">
                        <a href="profile.edit" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                            <i class="fas fa-user mr-3 text-gray-400"></i>
                            Profile
                        </a>
                        <a href="settings.index" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
