...
<!-- Sidebar -->
<div id="sidebar" class="fixed left-0 top-0 h-full w-72 bg-gradient-to-br from-gray-900 via-gray-800 to-black backdrop-blur-xl border-r border-gray-700 transform transition-transform duration-300 ease-in-out z-50 -translate-x-full lg:translate-x-0">
    <!-- Logo -->
    ...
    <nav class="p-4 space-y-2 overflow-y-auto h-[calc(100vh-100px)] custom-scrollbar">
        ...
        <div class="space-y-1">
            ...
            <button onclick="toggleDropdown('users'); setActiveMenu(this);"
                ...
                <i id="users-icon" class="fas fa-chevron-down transition-transform {{ $userMenuActive ? 'rotate-180' : '' }}"></i>
            </button>
        ...
        <div class="space-y-1">
            ...
            <button onclick="toggleDropdown('purchase'); setActiveMenu(this);"
                ...
                <i id="purchase-icon" class="fas fa-chevron-down transition-transform {{ $purchaseMenuActive ? 'rotate-180' : '' }}"></i>
            </button>
        ...
        <div class="space-y-1">
            ...
            <button onclick="toggleDropdown('inventory'); setActiveMenu(this);"
                ...
                <i id="inventory-icon" class="fas fa-chevron-down transition-transform {{ $inventoryMenuActive ? 'rotate-180' : '' }}"></i>
            </button>
        ...
        <div class="space-y-1">
            ...
            <button onclick="toggleDropdown('settings'); setActiveMenu(this);"
                ...
                <i id="settings-icon" class="fas fa-chevron-down transition-transform {{ $settingsMenuActive ? 'rotate-180' : '' }}"></i>
            </button>
