        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-2xl p-6">
            <div class="flex items-start space-x-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-yellow-800 mb-4">{{ $lowStockAlerts->count() }} item memiliki stok di bawah minimum</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select name="status"
                        ...
                        <option value="available" {{ request('status') == 'available' ? 'selected' : '' }}>Ada Stok</option>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-xs text-gray-400">{{ $stock->item->unit }} • Min: {{ $stock->item->min_stock }}</div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    <div class="font-medium text-lg">{{ number_format($stock->quantity_available) }}</div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2 mt-1">
                                        <div class="bg-gradient-to-r from-blue-600 to-green-600 h-2 rounded-full" style="width: {{ $percentage }}%"></div>
                                    </div>
