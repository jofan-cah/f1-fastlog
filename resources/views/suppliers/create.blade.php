                ...
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <div class="flex items-center">
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <span class="ml-3 text-sm font-medium text-gray-900" x-text="$el.previousElementSibling.checked ? 'Aktif' : 'Nonaktif'">Aktif</span>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="flex items-start space-x-4">
            ...
            <div>
                ...
                <ul class="text-sm text-blue-800 space-y-1">
                    <li>• <strong>Kode Supplier:</strong> Gunakan format yang konsisten seperti SUP001, SUP002, dst.</li>
